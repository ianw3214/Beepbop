...
class Module:
    def __init__(self, client, prefix, invalidCommandHandler=None):
        self.prefix = prefix
        ...
        self.reactListeners = {}
        self.client = client
        self.invalidCommandHandler = invalidCommandHandler
    ...
    async def handleMessageCommand(self, rawMessage, tokens):
        ...
        elif self.invalidCommandHandler:
            await self.invalidCommandHandler(rawMessage, tokens[1:])
